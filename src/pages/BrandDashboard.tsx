...
import { HolidayAlert } from "@/components/platform/HolidayAlert";
import { FXAlert } from "@/components/platform/FXAlert";
...
export default function BrandDashboard() {
  ...
  return (
    ...
    <Layout>
      <SEO title="Your orders — Clewa" description="Every active order, factory relationship, and production milestone in one place." />
              ...
              {loadingByof ? (
                ...
                <>
                  ...
                  <Button variant="outline" className="w-full" asChild>
                    <Link to="/directory"><Search className="mr-2 h-4 w-4" />Browse Clewa network</Link>
                  </Button>
                </>
              ) : (
              ...
              <div className="bg-card border border-border rounded-xl p-6">
                ...
                <div className="space-y-6">
                  ...
                  <div className="border-t border-border pt-6">
                    ...
                    <p className="text-xs text-muted-foreground mb-3">Share Clewa with another founder. They get their first order free — same as you did.</p>
                    <div className="flex gap-2">
                      <input
                        type="text"
                        readOnly
                        value={`https://clewa.io/auth?mode=signup&ref=${user?.id?.slice(0,8) || "clewa"}`}
                      ...
                      <Button
                        ...
                        variant="outline"
                        onClick={() => {
                          navigator.clipboard.writeText(`https://clewa.io/auth?mode=signup&ref=${user?.id?.slice(0,8) || "clewa"}`);
