...
export default function Privacy() {
  return (
    <Layout>
      <SEO
        title="Privacy — Clewa"
        description="How Clewa handles your data. Plain language — not legal boilerplate."
        canonical="/privacy"
      />
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <div className="prose max-w-none">
              <p className="text-lg text-muted-foreground leading-relaxed mb-10">
                Clewa handles commercially sensitive information — factory names, order pricing, product specifications, delivery windows. This page explains what we do with that information in plain language.
              </p>
              ...
              <div className="space-y-10">
                ...
                {/* Order data */}
                <div>
                  <h2 className="font-body text-xl font-bold text-foreground mb-3">Who can see your order data</h2>
                  <p className="text-muted-foreground leading-relaxed">
                    Every order on Clewa is visible only to the brand and the factory on that specific order. This is enforced at the database level — row-level security means other users cannot access your orders, regardless of permissions. No other brand sees your orders, specs, pricing, or factory relationships.
                  </p>
                </div>

                {/* Pricing */}
                <div>
                  <h2 className="font-body text-xl font-bold text-foreground mb-3">Your pricing and factory relationships</h2>
                ...
                {/* Data you provide */}
                <div>
                  <h2 className="font-body text-xl font-bold text-foreground mb-3">What we collect and why</h2>
                  <p className="text-muted-foreground leading-relaxed mb-3">
                ...
                {/* Disputes */}
                <div>
                  <h2 className="font-body text-xl font-bold text-foreground mb-3">Disputes</h2>
                  <p className="text-muted-foreground leading-relaxed">
                    If there is a dispute between a brand and a factory, Clewa provides the documented record — every message, spec version, revision, and milestone — as a neutral reference. We do not take sides, rule on outcomes, or share the record with parties outside the dispute. We give both parties access to the same documented history.
                  </p>
                </div>

                {/* Your data when you leave */}
                <div>
                  <h2 className="font-body text-xl font-bold text-foreground mb-3">Your data if you cancel</h2>
                  <p className="text-muted-foreground leading-relaxed">
                ...
                {/* AI */}
                <div>
                  <h2 className="font-body text-xl font-bold text-foreground mb-3">AI and your data</h2>
                  <p className="text-muted-foreground leading-relaxed">
                ...
                {/* Cookies */}
                <div>
                  <h2 className="font-body text-xl font-bold text-foreground mb-3">Cookies</h2>
                  <p className="text-muted-foreground leading-relaxed">
                ...
                {/* Your rights */}
                <div>
                  <h2 className="font-body text-xl font-bold text-foreground mb-3">Your rights</h2>
                  <p className="text-muted-foreground leading-relaxed">
                ...
                <div className="p-6 rounded-xl bg-card border border-border">
                  <h2 className="font-body text-lg font-bold text-foreground mb-2">Questions</h2>
                  <p className="text-muted-foreground leading-relaxed mb-3">
