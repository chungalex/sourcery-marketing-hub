...
import { ArrowRight, Quote, TrendingUp, Shield, Package } from "lucide-react";
        ...
        <div className="container-wide">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <p className="text-foreground">
              <span className="font-medium">Need hands-on help?</span>{" "}
              <span className="text-muted-foreground">Our consulting team can handle sourcing, audits, and launch strategy for you.</span>
            </p>
            <Link to="/consulting">
