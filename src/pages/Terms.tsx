...
const sections = [
  {
    ...
    content: `By accessing and using Clewa's services, you accept and agree to be bound by the terms and provisions of this agreement. If you do not agree to these terms, please do not use our services.`,
  },
  {
    title: "Description of Services",
    content: `Clewa is a manufacturing operating system for physical product brands. Our services include:
...
• Late payments may incur additional charges`,
  },
  {
    ...
    content: `All content, trademarks, and intellectual property on our platform remain the property of Clewa or respective owners. Users retain ownership of their product designs and specifications shared through our platform.`,
  },
  {
    title: "Client Due Diligence & Responsibility",
    content: `While Clewa works diligently to vet and curate our factory network, all manufacturing partnerships formed through our platform are ultimately the client's responsibility. By using our services, you acknowledge and agree that:
...
• Clewa does not guarantee the accuracy of factory-provided information or third-party data
...
We encourage all clients to visit factories in person when possible, request references, and start with smaller orders to build trust with new manufacturing partners.`,
  },
  {
    ...
    content: `Clewa acts as a facilitator between brands and factories. While we vet our factory partners and provide quality control services, we are not liable for:
...
The arbitration shall be conducted in San Francisco, California.`,
  },
  {
    ...
    content: `You agree to indemnify and hold harmless Clewa, its officers, directors, employees, and agents from any claims, damages, losses, liabilities, costs, or expenses (including reasonable attorney's fees) arising from:
...
• Any content or materials you submit to the platform`,
  ...
  {
    title: "Termination",
    content: `Clewa reserves the right to suspend or terminate your account at any time for:
...
export default function Terms() {
  return (
    <Layout>
      <SEO
        title="Terms of Service | Clewa"
        description="Read the terms and conditions governing your use of Clewa's manufacturing sourcing platform and services."
        canonical="/terms"
      />
        ...
        <div className="container-tight">
          ...
          <div className="prose prose-neutral max-w-none">
            <p className="text-lg text-muted-foreground mb-8">
              These Terms of Service govern your use of Clewa's platform and services. Please read them carefully before using our services.
            </p>
