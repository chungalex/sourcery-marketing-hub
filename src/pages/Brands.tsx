...
export default function Brands() {
  return (
    <Layout>
      <SEO
        title="For Brands — Clewa"
        description="Production is hard to start and just as hard to scale. Clewa is the marketplace to find the right factory and the OS to manage every order — first-time founders to experienced operators."
      />
          ...
          <div className="max-w-3xl">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
              ...
              <p className="text-base font-medium text-foreground mb-8 max-w-2xl">
                Clewa is the infrastructure it's always needed.
              </p>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="p-8 rounded-2xl bg-background border border-border">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                Production has its own language and its own process — incoterms, AQL standards, sampling gates, revision rounds. Clewa explains every decision before you make it, walks you through every stage, and gives you a vetted factory network to start from if you don't have one.
              </p>
