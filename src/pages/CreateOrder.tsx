...
import { IncotermsGuidance, AQLGuidance, MilestoneGuidance, TetWarning, TechPackGuidance, FirstMessageGuidance } from "@/components/onboarding/POGuidance";
...
const orderSchema = z.object({
  ...
  qc_option: z.enum(["clewa", "byoqc", "factory"]),
...
export default function CreateOrder() {
  ...
  // Group factories: BYOF (brand's own) vs Clewa Network
