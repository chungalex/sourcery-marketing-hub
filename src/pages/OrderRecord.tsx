...
export default function OrderRecord() {
  ...
  if (notFound || !order) return (
    <div className="min-h-screen flex items-center justify-center bg-background">
      <div className="text-center">
        ...
        <Link to="/" className="text-sm text-primary hover:underline">Clewa →</Link>
      </div>
    </div>
  );
  ...
  return (
    <>
      <SEO
        title={`${productName} — Production Record | Clewa`}
        description={`${order.quantity} units of ${productName}${order.factories ? ` produced by ${order.factories.name}` : ""}. Documented on Clewa.`}
      />
      <div className="min-h-screen bg-background">
        ...
        <div className="border-b border-border">
          <div className="max-w-2xl mx-auto px-4 py-4 flex items-center justify-between">
            <Link to="/" className="flex items-center gap-2">
              ...
              <span className="font-semibold text-foreground">Clewa</span>
            </Link>
        ...
        <div className="max-w-2xl mx-auto px-4 py-12">
          ...
          <div className="bg-card border border-border rounded-xl p-6 mb-8">
            <p className="text-xs font-semibold text-muted-foreground uppercase tracking-wide mb-4">Documented on Clewa</p>
          ...
          <div className="border-t border-border pt-8">
            <p className="text-sm text-muted-foreground mb-4">
              This production record was documented on Clewa — the manufacturing OS for physical product brands.
            </p>
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <Button variant="outline" asChild>
                <Link to="/how-it-works" className="flex items-center gap-2">
                  How Clewa works <ExternalLink className="h-3.5 w-3.5" />
                </Link>
              </Button>
            </div>
          </div>
