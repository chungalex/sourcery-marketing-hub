            ...
            <div className="grid lg:grid-cols-2 gap-10 items-end">
              <div>
                ...
                <p className="text-lg text-muted-foreground leading-relaxed">
                  The production community doesn't have a neutral space. Clewa's forum is three channels: founders talking to founders, factories announcing capacity, and open supply chain discussion on tariffs, freight, and market moves.
                </p>
              </div>
