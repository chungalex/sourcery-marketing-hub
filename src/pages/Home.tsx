...
const SITUATIONS = [
  {
    ...
    body: "Browse verified manufacturers with real performance scores — built from completed orders, never self-reported. AI factory matching from a plain-language brief. Compare quotes from multiple factories side by side. Your first structured order, fully guided.",
    features: [
      "Factory directory — verified manufacturers across Vietnam, Indonesia, Bangladesh, China",
...
const LIFECYCLE = [
  ...
  { n: "06", title: "Pay", detail: "Milestone gates + escrow tracking" },
