...
const articles: Record<string, {
  ...
  "what-is-aql": {
    ...
    sections: [
      ...
      {
        heading: "What Clewa does",
        body: "When you create an order on Clewa, the AQL selector explains what each level means before you commit — including how many units will be inspected and what defect count will trigger a failure. The QC gate on the final payment milestone is set to the AQL level you chose at order creation. You can't accidentally accept a failing inspection without explicitly overriding the gate.",
      },
    ],
...
export default function ResourceArticle() {
  ...
  return (
    <Layout>
      <SEO
        title={`${article.title} — Clewa Resources`}
            ...
            <div className="grid lg:grid-cols-3 gap-12 items-start">
              ...
              <div className="space-y-5">
                ...
                <div className="p-4 rounded-xl bg-card border border-border">
                  ...
                  <p className="text-xs text-muted-foreground leading-relaxed mb-3">Clewa enforces the structure this guide describes — AQL gates, milestone payments, revision rounds. Your first order is free.</p>
