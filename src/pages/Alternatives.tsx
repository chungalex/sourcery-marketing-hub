...
const COMPARISON = [
  {
    feature: "Free tier",
    clewa: true,
    clewa_note: "First order free, no time limit",
    anvyl: false,
  ...
  },
  {
    ...
    clewa: true,
    clewa_note: "Founding team based in HCMC",
    anvyl: "partial",
  ...
  },
  {
    ...
    clewa: true,
    clewa_note: "Full OS works with any factory",
    anvyl: true,
    pietra: false,
  ...
  },
  {
    ...
    clewa: true,
    clewa_note: "Has full order context",
    anvyl: "partial",
    pietra: false,
  },
  {
    ...
    clewa: true,
    clewa_note: "Built specifically for Vietnam",
    anvyl: false,
    pietra: false,
  },
  {
  ...
  },
  {
    ...
    clewa: true,
    clewa_note: "Auto-calculated from delivery date",
    anvyl: "partial",
  ...
  },
  {
    ...
    clewa: true,
    clewa_note: "Verified from real order data",
    anvyl: true,
...
export default function Alternatives() {
  return (
    <Layout>
      <SEO
        title="Clewa vs alternatives — Factory relationship infrastructure comparison"
        description="Compare production management platforms. Clewa vs enterprise platforms: pricing, features, and which stage each is built for."
      />
      ...
      <section className="section-padding border-b border-border">
        <div className="container max-w-4xl">
          ...
          <h1 className="text-4xl font-bold text-foreground mb-4">
            Clewa vs the alternatives.
The only platform built for the complete factory relationship.
          </h1>
          <p className="text-lg text-muted-foreground leading-relaxed">
            Most production management tools were built for enterprise brands with $10M+ in revenue. Clewa was built for brands from their first order — and by people who actually manufacture.
          </p>
        </div>
      </section>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-border">
                ...
                <th className="px-4 py-3 text-center font-semibold text-primary">Clewa</th>
            ...
            <tbody className="divide-y divide-border">
              {COMPARISON.map(row => (
                <tr key={row.feature} className="hover:bg-secondary/30 transition-colors">
                  ...
                  <Cell value={row.clewa as any} note={row.clewa_note} />
