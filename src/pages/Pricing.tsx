...
const TIERS = [
  {
    ...
    badge: null,
    concept: "Your first order. Fully protected. Every step guided.",
  ...
  },
  {
    ...
    badge: "Most popular",
    concept: "The intelligence layer activates. The platform watches every order and tells you what's at risk.",
  ...
  },
  {
    ...
    signoff: "Your whole operation visible. Every factory, every season, compliance built in.",
    cta: "Start Scale",
      ...
      <section className="section-padding border-b border-border">
        <div className="container max-w-2xl">
          <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <h1 className="text-4xl font-bold tracking-tight md:text-5xl font-normal text-foreground mb-5 leading-tight">
