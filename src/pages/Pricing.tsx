...
export default function Pricing() {
  ...
  return (
    <Layout>
      <SEO
        title="Pricing — Sourcery | Enterprise supply chain tools from $49/month"
