...
const faqSections = [
  {
    ...
    faqs: [
      ...
      {
        q: "Who built Clewa?",
        a: "Clewa was built by operators with direct experience on both sides of manufacturing — as brands managing production and as manufacturers supplying them. Every feature exists because we encountered the problem it solves.",
      },
      {
        q: "Is Clewa an agency or a platform?",
        a: "A platform. Clewa doesn't manage your factory relationships, negotiate on your behalf, or intervene in production. It gives you the structure, documentation, and milestone gate enforcement to manage your own production — with accountability built into every stage.",
      },
      {
        q: "What types of products does Clewa support?",
    ...
    faqs: [
      {
        ...
        a: "No. Bring Your Own Factory is the primary entry point. Invite your existing manufacturer and manage every order on-platform immediately. The marketplace is there when you need to find a new manufacturing partner — both paths work on the same platform.",
      },
      {
      ...
      },
      {
        ...
        a: "BYOF (Bring Your Own Factory) is for brands who already have a manufacturer they work with. Invite them to the platform and manage every order on-platform immediately — no network membership required. The marketplace is for brands who need to find a new factory. Both paths use exactly the same order management, documentation, and payment infrastructure.",
      },
      {
      ...
      },
      {
        ...
        a: "The QC gate blocks final payment until you approve the inspection result. If goods arrive with defects, you have a documented record of what was agreed and what was delivered — every spec, revision, and message is attached to the order. You can file a formal defect report, withhold the final milestone, and negotiate from a position of documented evidence. Clewa provides the structure and the record — not the ruling. How QC is conducted is your choice: a third-party inspector you book directly (SGS, QIMA, Bureau Veritas), factory self-reporting with structured photo evidence, or a Clewa arrival checklist when goods reach you."
      },
      {
      ...
      {
        q: "Does Clewa handle shipping and logistics?",
    ...
    faqs: [
      {
        ...
        a: "No. Network membership is free. Clewa charges brands a subscription fee — factories join and use the full platform at no cost.",
      },
      {
  ...
  },
  {
    ...
    faqs: [
      {
        q: "How much does Clewa cost?",
        a: "Clewa offers a free first order, a one-off option at $79/order, and annual subscriptions — Builder at $399/year and Pro at $699/year. Your first order is always free, no credit card required. See the full breakdown on the pricing page.",
      },
      {
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Yes. It queries real factory rows in the Clewa database — if no factories match your criteria, it returns an empty state with suggestions. It never generates fictional results.",
      },
      {
...
export default function FAQ() {
  return (
    <Layout>
      <SEO
        title="FAQ — Clewa"
        description="Common questions about Clewa — pricing, how it works, factory vetting, BYOF, and the AI toolkit."
      />
