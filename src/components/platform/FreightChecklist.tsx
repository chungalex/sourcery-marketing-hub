...
function getChecklist(incoterms: string, destination: string): CheckItem[] {
  ...
  return [
    ...
    // Optional quality
    { id: "qc_report", label: "QC inspection report", description: "Third-party or Clewa-documented QC results. Not legally required but strongly recommended.", required: false, done: false },
