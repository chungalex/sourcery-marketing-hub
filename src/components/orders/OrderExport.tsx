...
export function OrderExport({ order, isPro = false }: OrderExportProps) {
  ...
  const generatePDF = async () => {
    ...
    try {
      ...
      const displayBrand = isPro && brandName.trim() ? brandName.trim() : "Clewa";
...
<div class="footer">
  <p>This document was generated from ${isPro && brandName ? brandName : "Clewa"} — production management platform.</p>
