...
*Read this + CLEWA_DOCTRINE.md at the start of every session before touching any code.*
...
- WhyClewa, Features, About, HowItWorks, Factories, CaseStudies, Brands, Intelligence, Alternatives, Auth, Footer — all updated
...
- Before: Every new user sees same generic "How Clewa works" card
...
- ✗ Hands-on managed operations beyond Clewa Managed
...
- [ ] Register Clewa trademark USPTO ~$350
- [ ] Incorporate Clewa as separate legal entity
...
- Revenue model: SaaS + Clewa Managed + future GMV fee + future data product
...
Read SESSION_BRIEF.md and CLEWA_DOCTRINE.md first.
